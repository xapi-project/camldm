...
(* OASIS_START *)
(* DO NOT EDIT (digest: 735669734c1406ec550a40bfe1f035f6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["various"];
          homepage = None;
          synopsis = "Bindings to libdevicemapper";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["camldm_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-ldevmapper"])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\193\129\160\002\132<\b\142\t \167\026\205\190RT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
